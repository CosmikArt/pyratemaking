...
def _mack_1993_triangle() -> pd.DataFrame:
    ...
    data = {
        ...
        24:  [1124788, 1236139, 1292306, 1418858, 1136350, 1333217, 1288463, 1421128, 1363294, np.nan],
        36:  [1735330, 2170033, 2218525, 2195047, 2128333, 2180715, 2419861, 2864498, np.nan, np.nan],
